      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div>
              ...
              <form className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-rose-600 hover:bg-rose-700 text-white py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center cursor-pointer"
                >
            ...
            <div>
              ...
              <form className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-rose-100 hover:bg-rose-200 text-rose-700 py-3 rounded-lg font-medium transition-colors duration-300 flex items-center justify-center cursor-pointer"
                >
                  Update Password
                </button>
                ...
                <button
                  ...
                  className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 rounded-lg font-medium transition-colors duration-300 flex items-center justify-center mt-4 cursor-pointer"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">
              See your saved favorite products
            </p>
          </div>
