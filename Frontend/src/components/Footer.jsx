  ...
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[40px]">
      <div className=" flex justify-between py-[5%]">
        <div>
          <img src="/banner1.png" alt="" height={200} width={200} />
          <p className="mt-2">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="mt-2">Long Hoa, Chau Thanh, Tra Vinh</p>
          <p className="mt-2">Phone: 0339601263</p>
          <p className="mt-2">Email: bookstore@gmail.com</p>
        </div>
      </div>
